    ...
    public class Client
    {
        ...
        public string GetBearerToken()
        {
            JToken token = JObject.Parse(
                GetBearerTokenJson(
                    "4HRbgQQmRLF6OB8hefm4FiL8g",
                    "HYkatAOQMMUxGOMM9p5DGFRiYvItEJEJYaD46u17mBtMuEO6Xb"));
        ...
        {
            var webrequest = WebRequest.Create("https://api.twitter.com" + url);
        ...
        public static string ReadResponse(WebRequest webrequest)
        {
